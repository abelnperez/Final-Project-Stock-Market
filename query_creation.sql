...
CREATE TABLE IF NOT EXISTS `stock`.`balance` (
  ...
  `years` BIGINT NULL DEFAULT NULL,
  `cash_and_cash_equivalents` DOUBLE NOT NULL,
  ...
  PRIMARY KEY (`cash_and_cash_equivalents`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `stock`.`cashflow` (
  ...
  `free_cash_flow` DOUBLE NOT NULL,
  PRIMARY KEY (`free_cash_flow`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `stock`.`share` (
  ...
  `year_id` BIGINT NULL DEFAULT NULL,
  `years` BIGINT NULL DEFAULT NULL,
  `revenue_per_share` DOUBLE NOT NULL,
